...
- (NSString *) retrieveTimeAndDate {
	...
	NSString *userName = @"";
    if([date hourOfDay]<12) outputTimeAndDateText = NSLocalizedString(@"Good morning", @"Greeting in the morning");
    ...
    outputTimeAndDateText = [outputTimeAndDateText stringByAppendingString:NSLocalizedString(@"It's ", @"Declares the day")];
...
- (NSString *) getTimeAndDate {
	...
	outputTimeAndDateText = [outputTimeAndDateText stringByAppendingString: NSLocalizedString(@"Currently:\n \n", @"Declares the time. Ex. It is 19:30")];
