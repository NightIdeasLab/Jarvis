...
- (NSString *)stringByDecodingCharacterEntities {
    ...
    while (true) {
        ...
        NSRange start = [escaped rangeOfString: @"&" options: NSCaseInsensitiveSearch range: searchRange];
        ...
        NSRange finish = [escaped rangeOfString: @";" options: NSCaseInsensitiveSearch range: commaRange];
