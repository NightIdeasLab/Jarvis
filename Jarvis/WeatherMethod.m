	...
	if(woeidCodeWeather != nil) {
		...
		if(weatherContent != nil)
		{
			if ([[weatherContent componentsSeparatedByString:@"<b>Current Conditions:</b><br />"] count]>1)
			{
				...
				weatherText = [[weatherText componentsSeparatedByString:@"F<BR />"] objectAtIndex:0];
				...
				outputWeatherText = [outputWeatherText stringByAppendingString:@" degrees.\n"];
			}
		}
	...
	if(woeidCodeWeather != nil) {
		...
		if(weatherContent != nil)
		{
			if ([[weatherContent componentsSeparatedByString:@"<b>Current Conditions:</b><br />"] count]>1)
			{
				...
				outputWeatherText = [outputWeatherText stringByAppendingString:trimmedString];
				outputWeatherText = [outputWeatherText stringByAppendingString:@"º\n \n"];
			}
		}
