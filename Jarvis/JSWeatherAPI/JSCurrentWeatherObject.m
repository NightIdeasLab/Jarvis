...
- (id)initWithData:(NSDictionary *)dict temperatureConversion:(NSInteger)conversion
{
    ...
    self.objects = [NSDictionary dictionaryWithObjects:@[self.JSWeatherImage,
                                                         ...
                                                         [NSString stringWithFormat:@"%.2f", self.JSTemporaryMaxTemperature],
                                                         [NSString stringWithFormat:@"%.2f", self.JSTemporaryMinTemperature],
                                                         ...
                                                         [NSString stringWithFormat:@"%.2f", self.JSLocationLatitude],
                                                         [NSString stringWithFormat:@"%.2f", self.JSLocationLongitude],
                                                         self.JSSunriseDate,
                                                         self.JSSunsetDate]
                                               forKeys:@[@"image",
                                                         @"name",
