...
NSString * const kJSWeatherAPIQueryCoordinates = @"weather?";
NSString * const kJSWeatherAPIQueryLatitude = @"lat=";
NSString * const kJSWeatherAPIQueryLongitude = @"&lon=";
NSString * const kJSWeatherAPIQueryDailyForecast = @"forecast/daily?q=";
NSString * const kJSWeatherAPIQueryDailyForecastCoord = @"forecast/daily?";
