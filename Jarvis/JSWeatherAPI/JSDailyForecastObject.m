...
- (id)initWithData:(NSDictionary *)dict temperatureConversion:(NSInteger)conversion
{
    ...
    self.objects = [NSDictionary dictionaryWithObjects:@[self.JSWeatherImage,
                                                         ...
                                                         [NSString stringWithFormat:@"%.0f", self.JSDayForecastDayTemperature],
                                                         [NSString stringWithFormat:@"%.0f", self.JSDayForecastEveningTemperature],
                                                         [NSString stringWithFormat:@"%.0f", self.JSDayForecastMaxTemperature],
                                                         [NSString stringWithFormat:@"%.0f", self.JSDayForecastMinTemperature],
                                                         [NSString stringWithFormat:@"%.0f", self.JSDayForecastMorningTemperature],
                                                         [NSString stringWithFormat:@"%.0f", self.JSDayForecastNightTemperature],
